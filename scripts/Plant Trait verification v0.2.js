function createAnnotationCheckbox() {
    ...
    var examples = folder.getFilesByName('top_sents_all_AllSentencesAgainstTrait_Random20Subset_9.csv')
    ...
    for (var i = 1; i < data.length -1; i++) {
      ...
      // BASIC DATA
      var species_name = data[i][1]
      species_name
      var gt_MainTrait = data[i][3]
      var gt_SubTrait  = data[i][4];
      ...
      pageOne.setHelpText("The hand-annotated traits is/are:\n" + traitSentence)
  
  
      // Sentence 1
      sentence = form.addMultipleChoiceItem();
      choices = [
        sentence.createChoice('Unrelated'),
